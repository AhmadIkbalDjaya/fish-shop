    ...
    <div class="container-fluid">
      <div class="row m-4 justify-content-center">
        <div class="col-md-6 mb-3">
          <div class="card">
            <div class="login-box">
              <form action="{{ route('admin.fish.update', ['fish' => $fish->id]) }}" method="POST" enctype="multipart/form-data">
                @method('patch')
                @csrf
                <h4 class="mb-4 text-center">Produk</h4>
                <div class="user-box">
                  <input type="text" name="name" class="@error('name') is-invalid @enderror" value="{{ old("name", $fish->name) }}" required="" />
                ...
                <div class="user-box">
                  <input type="number" name="price" class="@error('price') is-invalid @enderror" value="{{ old("price", $fish->price) }}" required="" min="0"/>
                ...
                <div class="mb-3">
                  ...
                  <input type="file" name="image" id="formFile" class="form-control @error('image') is-invalid @enderror" value="{{ old("image") }}"/>
                  <sub>Kosongkan jika tidak ingin mengganti foto</sub>
                  @error('image')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
